 ...
 * - Cognitive/Social Learning Rate (C1 = C2) = 2.0
 *
...
public class PSO_Lite implements BenchmarkRunner.BenchmarkOptimizer {
    ...
    // PSO参数（标准 PSO，Shi & Eberhart；未削弱）
    private static final int POPULATION_SIZE = 30;
    private static final double W_MAX = 0.9;         // 最大惯性权重（标准初值）
    private static final double W_MIN = 0.4;         // 最小惯性权重（标准末值）
    private static final double C1 = 2.0;            // 认知学习率（标准）
    private static final double C2 = 2.0;            // 社会学习率（标准）
    private static final double V_MAX = 0.2;         // 最大速度（搜索范围的 20%，标准）
