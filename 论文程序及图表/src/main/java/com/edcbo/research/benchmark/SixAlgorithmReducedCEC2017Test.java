 ...
 *
 * 实验规模：
 * - 精简实验：5算法 × 12函数 × 30次 = 1800次测试（约1小时）
 * - 相比完整实验（4500次）减少60%时间
 *
 * 函数选择策略：
...
public class SixAlgorithmReducedCEC2017Test {
    ...
    public static void main(String[] args) {
        System.out.println("\n╔════════════════════════════════════════════════════════════════╗");
        System.out.println("║  CEC2017 Reduced Benchmark Test - 5 Algorithms × 12 Functions ║");
    ...
    public static void runReducedExperiment() {
        ...
        System.out.println("  - 总测试量：5 × 12 × " + NUM_RUNS + " = " + (5 * 12 * NUM_RUNS) + " 次");
        System.out.println("  - 预计用时：1 小时\n");
