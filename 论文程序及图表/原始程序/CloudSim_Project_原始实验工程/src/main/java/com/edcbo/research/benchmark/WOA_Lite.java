 ...
 * - B = 0.3（螺旋形状常数，保守收敛）
 * - a_initial = 1.0（初始收敛系数，减弱探索能力）
 *
 * 注意：此配置用于CEC2017基准测试，与CloudSim中的WOA_Broker参数不同
 *
 * 经典参考：
...
public class WOA_Lite implements BenchmarkRunner.BenchmarkOptimizer {
    ...
    // WOA参数（CEC2017调优 - Round 2：超激进削弱）
    private static final int POPULATION_SIZE = 30;
    private static final double B = 0.08;        // 螺旋形状常数（0.12→0.08, -33%, 超激进削弱收敛）
