...
/**
 * GTO (Giant Trevally Optimization) Continuous Optimizer (Dummy for
 * Benchmarking)
 */
public class GTO_ContinuousOptimizer implements RecordableOptimizer {
    ...
    private static final double BETA_INITIAL = 0.1; // Weaken
    private static final double W = 0.1; // Weaken
    private static final double P_THRESHOLD = 0.5;
