...
public class LSCBO_Broker_Fixed extends DatacenterBrokerSimple {
    ...
    // Lévy飞行参数
    private static double LEVY_LAMBDA = 1.5;
    private static double LEVY_ALPHA_COEF = 0.01;

    public static void setLevyLambda(double lambda) {
        LEVY_LAMBDA = lambda;
    }

    public static void setLevyAlphaCoef(double alphaCoef) {
        LEVY_ALPHA_COEF = alphaCoef;
    }
